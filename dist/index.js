...
var data = _interopDefault(require('emoji-mart/data/emojione.json'));
...
var emojiIndex = new emojiMart.NimbleEmojiIndex(data);
...
function CustomEmoji(_ref) {
  ...
  return React.createElement(emojiMart.Emoji, _extends({}, rest, { emoji: emojiData || LOADING_EMOJI }));
}

function EmojiWithCustomFallback(props) {
  return React.createElement(emojiMart.Emoji, _extends({}, props, {
...
exports.Icon = Iconify;
exports.EmojiProvider = index;
